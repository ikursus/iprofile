        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-bookmark-plus"></i> Tambah Program Baru
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('programs.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('kategori_program') is-invalid @enderror" 
                            ...
                            <option value="Kemahiran Teknikal" {{ old('kategori_program') == 'Kemahiran Teknikal' ? 'selected' : '' }}>Kemahiran Teknikal</option>
                            <option value="Kemahiran Insaniah" {{ old('kategori_program') == 'Kemahiran Insaniah' ? 'selected' : '' }}>Kemahiran Insaniah</option>
                            <option value="Kemahiran Keusahawanan" {{ old('kategori_program') == 'Kemahiran Keusahawanan' ? 'selected' : '' }}>Kemahiran Keusahawanan</option>
                            <option value="Kemahiran Kepimpinan" {{ old('kategori_program') == 'Kemahiran Kepimpinan' ? 'selected' : '' }}>Kemahiran Kepimpinan</option>
                            <option value="Lain-lain" {{ old('kategori_program') == 'Lain-lain' ? 'selected' : '' }}>Lain-lain</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('jenis_kemahiran') is-invalid @enderror" 
                            ...
                            <option value="Asas" {{ old('jenis_kemahiran') == 'Asas' ? 'selected' : '' }}>Asas</option>
                            <option value="Pertengahan" {{ old('jenis_kemahiran') == 'Pertengahan' ? 'selected' : '' }}>Pertengahan</option>
                            <option value="Lanjutan" {{ old('jenis_kemahiran') == 'Lanjutan' ? 'selected' : '' }}>Lanjutan</option>
                            <option value="Pakar" {{ old('jenis_kemahiran') == 'Pakar' ? 'selected' : '' }}>Pakar</option>
                        </select>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Simpan Program
                        </button>
                    </div>
                </form>
            </div>
